...
connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:todoappdockerserver.database.windows.net,1433;Database=todosqldb;Uid=aureuser;Pwd=Aceadmin@i23;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
app = FastAPI()
